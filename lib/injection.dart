...
Future<void> init() async {
  ...
  //Datasources
  getIt.registerLazySingleton(() => DetectorLocalDatasourceImpl(sharedPreferences: getIt()));
  getIt.registerLazySingleton(() => DetectorRemoteDatasourceImpl(client: getIt()));

  //Core
  getIt.registerLazySingleton(() => NetworkInfoImpl(connectivity: getIt()));
